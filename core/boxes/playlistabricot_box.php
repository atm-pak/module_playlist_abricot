 ...
 */
class playlistabricotbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "playlistabricot@playlistabricot";
    public $boxlabel;
    public $depends = array("playlistabricot");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/playlistabricot/class/playlistabricot.class.php";
