...
/**
 * 	\file		admin/playlistabricot.php
...
require_once '../lib/playlistabricot.lib.php';
 ...
 * View
 */
$page_name = "playlistAbricotSetup";
...
$head = playlistabricotAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104300Name"),
    0,
    "playlistabricot@playlistabricot"
);
