...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.playlistabricot.write;noerr]=1]
		...
		[onshow;block=begin;when [object.status]=[TplaylistAbricot.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[TplaylistAbricot.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[TplaylistAbricot.STATUS_REFUSED]]
