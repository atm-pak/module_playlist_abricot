...
/**
 * 	\file		core/triggers/interface_99_modMyodule_playlistAbricottrigger.class.php
 * 	\ingroup	playlistabricot
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modPlaylistabricot_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceplaylistAbricottrigger
{
